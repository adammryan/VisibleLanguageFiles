...
function createContentChart() {
    ...
    zingchart.render({
            id: 'graph-display',
            dataurl: urlBase +currentDataSet+ "/content.json"
        });
    }
    else{
        console.log('updating');
        zingchart.exec('graph-display', 'destroy');
        zingchart.render({
            id: 'graph-display',
            data: currentChart
        });
...
function createFunctionChart() {
    ...
    if(!update){
        ...
        zingchart.render({
            ...
            console.log('updating');
            var currData = getData(currChartType);
            console.log(currentChart);
            zingchart.exec('graph-display', 'setdata',  zingchart.render({
                data: currentChart 
            }));
        }
  }
...
function resetDisplay() {
    zingchart.exec('graph-display', 'clear');
}
