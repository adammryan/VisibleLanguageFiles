...
function populateGraphic() {
    ...
    segments.data(segmentData)                          // assigns the elements of an array to each element that will be created
        ...
        .transition()
            ...
            .delay(function(d, i) { return i * 300; })       // how long between each individual animation?
                                                             // if I pass in two parameters, the second one will represent the index of d in segmentData
}
populateGraphic();
